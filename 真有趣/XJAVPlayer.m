...
- (void)layoutSubviews{
    /** 底部菜单栏*/
    CGFloat playOrPauseBtnW = self.playOrPauseBtn.currentImage.size.width;
    CGFloat playOrPauseBtnH = self.playOrPauseBtn.currentImage.size.height;
    self.bottomMenuView.frame = CGRectMake(0, self.height-40, self.width, playOrPauseBtnH);
